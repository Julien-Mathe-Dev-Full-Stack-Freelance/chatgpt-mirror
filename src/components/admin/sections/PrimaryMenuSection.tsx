...
export function PrimaryMenuSection() {
  ...
  /* ── Hints d’erreur à l’affichage (parents + enfants, seulement si touched) ── */
  ...
  const onAdd = useCallback(
    ...
    [settings.items, patch, makeDefaultItem]
  );
  ...
  const onAddChild = useCallback(
    ...
    [settings.items, patch, makeDefaultChild]
  );
  ...
  return (
    ...
    >
      ...
      <p id="primary-menu-desc">{t("admin.menu.primary.desc")}</p>
