...
import { NewLinkFieldsItem } from "@/components/admin/molecules/NewLinkFieldsItem";
import { Button } from "@/components/ui/button";
import { useI18n } from "@/i18n/context";

export type MenuItemLike = Readonly<{
  label: string;
...
export type MenuFieldsItemProps<TItem extends MenuItemLike = MenuItemLike> =
  Readonly<{
    idPrefix: string;
    index: number;
    item: TItem;
