 ...
 * Aligné sur le pattern d’Identity.
 * @layer ui/hooks
 */
...
export type UseLegalMenuSettingsResult =
  SettingsHookResult<LegalMenuSettingsInput>;

/**
 * Hook Legal Menu — exposé en **modèle UI** (strings)
 ...
 *   (aligné sur Identity ; OK si on envoie `items` quand ça change)
 */
export function useLegalMenuSettings(
  ...
  return useSettingsResource<LegalMenuSettingsInput>({
    ...
    // Diff minimal sur valeurs normalisées (même choix qu’Identity)
