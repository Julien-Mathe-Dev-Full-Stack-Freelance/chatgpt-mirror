...
type PatchDTO<T> = Readonly<{ patch: Partial<T> }>;

export type UpdateHeaderSettingsDTO = PatchDTO<HeaderSettingsDTO>;
export type UpdateFooterSettingsDTO = PatchDTO<FooterSettingsDTO>;
export type UpdatePrimaryMenuSettingsDTO = PatchDTO<PrimaryMenuSettingsDTO>;
export type UpdateLegalMenuSettingsDTO = PatchDTO<LegalMenuSettingsDTO>;
export type UpdateSocialSettingsDTO = PatchDTO<SocialSettingsDTO>;
export type UpdateIdentitySettingsDTO = PatchDTO<IdentitySettingsDTO>;
export type UpdateSeoSettingsDTO = PatchDTO<SeoSettingsDTO>;
export type UpdateThemeSettingsDTO = PatchDTO<ThemeSettingsDTO>;
export type UpdateAdminSettingsDTO = PatchDTO<AdminSettingsDTO>;
