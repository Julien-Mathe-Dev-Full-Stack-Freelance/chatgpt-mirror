...
/* ──────────────────────────────────────────────────────────────────────────────
   Helpers optionnels (type-guards) — utiles si ces types proviennent d’IO/JSON.
   Dé-commente si besoin dans ton projet.
───────────────────────────────────────────────────────────────────────────────*/
// export function isBlockingIssue(v: unknown): v is BlockingIssue {
//   return (
//     !!v &&
//     typeof v === "object" &&
//     typeof (v as any).code === "string" &&
//     Array.isArray((v as any).path)
//   );
// }

// export function isUiWarning(v: unknown): v is UiWarning {
//   return !!v && typeof v === "object" && typeof (v as any).code === "string";
// }
