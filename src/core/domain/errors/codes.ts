...
export const ERROR_CODES = {
  ...
  /** ⚠️ New: generic validation failure at the domain boundary */
  ...
  // ——— Social ———
  SOCIAL_DUPLICATE_KIND: "SOCIAL_DUPLICATE_KIND", // même "kind" présent plusieurs fois
  SOCIAL_INVALID_FOR_PLATFORM: "SOCIAL_INVALID_FOR_PLATFORM", // incohérence kind ↔ schéma href (ex: email sans mailto:, non-email avec mailto:, website ni relatif ni http(s), etc.)
  SOCIAL_ABSOLUTE_REQUIRED: "SOCIAL_ABSOLUTE_REQUIRED", // plateforme (hors website/email) exige http(s) absolu
  SOCIAL_INVALID_HREF: "SOCIAL_INVALID_HREF", // href malformé (garde-fou générique ; rarement déclenché si branding déjà fait)
