 ...
 * @description
 * - Baseline des routes relatives `/…` : utilisée par les seeds i18n et les menus admin.
 * - Toujours passer par `rel()` / `href()` (`src/core/domain/urls/href.ts`) avant exposition.
 * - Tenir aligné avec les routes Next (page d’accueil, mentions légales, politique cookies).
 */
