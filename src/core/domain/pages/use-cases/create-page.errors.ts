...
export const CREATE_PAGE_ERROR_NAME = "CreatePageError" as const;

/** Sous-ensemble de codes typiquement levés par CreatePage. */
export const CREATE_PAGE_ERROR_CODES = [
...
export type CreatePageErrorCode =
  | (typeof CREATE_PAGE_ERROR_CODES)[number]
  | ErrorCode;
