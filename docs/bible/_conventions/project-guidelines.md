...
- **Confirmation utilisateur** : en cas de plusieurs options légitimes, exposer les alternatives et attendre la validation.
- **Tests** : ne lancer les scripts de tests ou de lint qu'à la demande explicite de l'utilisateur.
- **Mises à jour des règles** : enrichir ce document dès qu'une nouvelle convention technique est décidée.
